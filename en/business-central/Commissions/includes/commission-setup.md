...
| **Document No. for Manager Commissions**        | You can define the document number that should be used when posting manager commissions. The parameters that can be used are the following:<br><br>- %1 = Day<br>- %2 = Month<br>- %3 = Year<br>- %4 = Month Text |
