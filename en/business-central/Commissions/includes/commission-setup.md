...
|                                                    |                                                                                                    |
|----------------------------------------------------|----------------------------------------------------------------------------------------------------|
| **Initial Rate per Campaign**                      | When enabled, a different (initial) commission rate can be defined for a new customer per campaign. The initial rate applies the first time a salesperson sells to a new customer within the context of a specific campaign. |
| **Initial Rate per Ship-to**                       | When enabled, a different (initial) commission rate can be defined per ship-to address. The initial rate applies for the first sale to a new ship-to address, allowing salespeople to earn higher commissions when opening new ship-to locations. |
| **Initial Rate per Salesperson**                   | When enabled, the initial commission rate tracking is per salesperson. This means each salesperson can earn an initial rate for their first sale to a customer, even if another salesperson has previously sold to that same customer. |
| **Initial Rate per Entity**                        | When enabled, the initial commission rate applies per entity (item, item category, resource, etc.). This allows a salesperson to earn an initial rate for the first time they sell a specific item or item category to a customer, incentivizing the introduction of new products. |
