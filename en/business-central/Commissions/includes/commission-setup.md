...
| **Commission Effective Date**               | - **Date Entered**: The work date the sales transaction is entered<br>- **Order Date**: The date the order was placed. This is the “Order Date” on the sales document.<br>- **Shipment Date**: The date the order will be shipped. This is based on the **Shipment Date** field on the sales document.<br>- **Invoice Date**: The date the document will be posted. This is based on the “Posting Date” field on the sales document. |
