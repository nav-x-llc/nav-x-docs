...
|                            |                                                                                                                              |
|----------------------------|------------------------------------------------------------------------------------------------------------------------------|
| **Catch Weights**          | - [Getting Started](catch-weights/getting-started.md)<br>- [Permission Setups](catch-weights/permission-setups.md)<br>- [Release Notes](catch-weights/release-notes.md) |
...
| **Custom Fields**          | - [Getting Started](custom-fields/getting-started.md)<br>- [Permission Setups](custom-fields/permission-setups.md)<br>- [Release Notes](custom-fields/release-notes.md) |
| **Document Attachment Merge** | - [Getting Started](document-attachment-merge/getting-started.md)<br>- [Permission Setups](document-attachment-merge/permission-setups.md)<br>- [Release Notes](document-attachment-merge/release-notes.md) |
| **External File Storage**  | - [Getting Started](external-file-connector/getting-started.md)<br>- [Permission Setups](external-file-connector/permission-setups.md)<br>- [How to Configure the Folder Path Template](external-file-connector/how-to-configure-folder-template.md)<br>- [How to Pick a File from External Storage](external-file-connector/how-to-pick-from-storage.md)<br>- [Release Notes](external-file-connector/release-notes.md) |
| **External File Storage - Datto Workplace** | - [Getting Started](datto-workplace/getting-started.md)<br>- [Permission Setups](datto-workplace/permission-setups.md)<br>- [How to Add a Datto Workplace Account](datto-workplace/how-to-add-account.md)<br>- [How to Manage Accounts](datto-workplace/how-to-manage-accounts.md)<br>- [Release Notes](datto-workplace/release-notes.md) |
| **External File Storage - FTP Connector** | - [Getting Started](ftp-connector/getting-started.md)<br>- [Permission Setups](ftp-connector/permission-setups.md)<br>- [How to Add an FTP/SFTP Account](ftp-connector/how-to-add-account.md)<br>- [How to Manage Accounts](ftp-connector/how-to-manage-accounts.md)<br>- [Release Notes](ftp-connector/release-notes.md) |
...
| **National Accounts**      | - [Getting Started](national-accounts/getting-started.md)<br>- [Permission Setups](national-accounts/permission-setups.md)<br>- [How to create National Accounts Customers](national-accounts/how-to-create-national-accounts-customers.md)<br>- [Release Notes](national-accounts/release-notes.md) |
| **OpSuite Integration**    | - [Getting Started](opsuite/getting-started.md)<br>- [Permission Setup](opsuite/permission-setups.md)<br>- [How to integrate Financial Summary Data](opsuite/how-to-finance.md) |
...
| **Warehouse Productivity** | - [Assembly Picks - Getting Started](warehouse/assembly-picks/getting-started.md)<br>- [Quarantine Zones - Getting Started](warehouse/quarantine-zones/getting-started.md)<br>- [Warehouse Adjustments - Getting Started](warehouse/warehouse-adjust/getting-started.md) |
