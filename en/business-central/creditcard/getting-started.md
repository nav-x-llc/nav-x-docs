...
The next two steps allow you to configure the behavior of the credit card functionality. They are already pre-configured with default values, but if those values do not fit your process, please change them. The following table describes each of the fields available.
